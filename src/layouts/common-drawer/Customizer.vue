<template>
  <div>
    ...
    <v-navigation-drawer
      ...
      :left="$vuetify.rtl"
    >
      <v-app-bar class fixed flat>
        <div class="flex justify-between align-center">
          <div class="card-title m-0">Customizer</div>
          <div class>
      ...
      <base-card class="mb-3">
        ...
        <v-card-text>
          ...
          <v-card @click="changeLayout('VerticalSidebar')" ripple class="rounded-lg portrait mb-4">
            <v-img src="@/assets/images/screenshots/layout1.png" aspect-ratio="1.4" contain></v-img>
          </v-card>
          <v-card
          ...
          >
            <v-img src="@/assets/images/screenshots/layout2.png" aspect-ratio="1.4" contain></v-img>
          </v-card>
          <v-card
            ...
            class="rounded-lg portrait mb-4"
          >
            <v-img src="@/assets/images/screenshots/layout3.png" aspect-ratio="1.4" contain></v-img>
          </v-card>
          <v-card @click="changeLayout('HorizontalBar')" ripple class="rounded-lg portrait mb-4">
            <v-img src="@/assets/images/screenshots/layout4.png" aspect-ratio="1.4" contain></v-img>
          </v-card>
        </v-card-text>
      </base-card>
      <base-card class="mb-3 mt-4">
        ...
        <v-card-text>
          ...
          <v-btn v-else @click="changeDarkMode(false)" class="mr-4 mb-4" color="white" small fab>
      ...
      <base-card class="mb-3">
        ...
        <v-card-text>
          <v-btn v-if="!$vuetify.rtl" @click="changeThemeRtlMode(true)" class="mr-4 mb-4" small fab>
            <v-icon>mdi-dock-right</v-icon>
          </v-btn>
          <v-btn v-else @click="changeThemeRtlMode(false)" class="mr-4 mb-4" small fab>
...
export default {
  ...
  methods: {
    ...
    changeLayout(layout) {
      if (layout == "VerticalCompactSidebar") {
